...
class IncubatorDAO(BaseDAO):
    ...
    def __init__(self,
        ...
        self.incubator_object_collection = self.client["devices"]
        self.incubator_execution_collection = self.client["devices_execution"]

    def create_entry(self, object_name: str, status, **kwargs) -> ObjectId:
        self.object_name = object_name

        # if exist the same object_name then update the status
        query_res = self.incubator_object_collection.find_one(
        ...
        try:
            self.incubator_object_collection.insert_one(entry)
    ...
    def log_step(self, step: str,
        ...
        self.incubator_execution_collection.insert_one(entry)

    def update_status(self, status):
        (self.incubator_object_collection.
