...
weight_name="sdl-proj-head-ckpt-2"
loss_type="weighted_mse"

cd /h/pangkuan/dev/SDL-LNP/model/evaluation/notebooks/
/h/pangkuan/miniconda3/envs/unimol/bin/python /h/pangkuan/dev/SDL-LNP/model/evaluation/notebooks/unimol_huggingface_kfold.py --weight-name $weight_name --loss-type ${loss_type}