...
weight_name="a100-contrastive-ckpt-2"


cd /h/pangkuan/dev/SDL-LNP/model/evaluation/notebooks/
/h/pangkuan/miniconda3/envs/unimol/bin/python /h/pangkuan/dev/SDL-LNP/model/evaluation/notebooks/unimol_huggingface_kfold.py --weight-name ${weight_name} --loss-type "normalized_preference_log" --save-model