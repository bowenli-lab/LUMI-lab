...
@register_model("unimol_contrastive")
class UniMolModelContrastive(BaseUnicoreModel):
    @staticmethod
    def add_args(parser):
    ...
    def __init__(self, args, dictionary):
        super().__init__()
        unimol_base_architecture_contrastive(args)
        self.args = args
    ...
    def forward(
        ...
        **kwargs,
        ...
        # normalize repr
        molecule_embedding = encoder_rep[:, 0, :]
        molecule_embedding = self.proj_head(molecule_embedding)
        # normalize
        ...
        if self.args.mode == "infer":
            ...
            return (
                ...
                x_norm,
                delta_encoder_pair_rep_norm,
                molecule_embedding, # cls embeddings
            )
...
@register_model_architecture("unimol_contrastive", "unimol_contrastive")
def base_architecture_contrastive(args):
...
@register_model_architecture("unimol_contrastive", "unimol_contrastive_base")
def unimol_base_architecture_contrastive(args):
    base_architecture_contrastive(args)
