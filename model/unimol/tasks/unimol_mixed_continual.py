...
class MergedLMDBDataset:
    ...
    def __len__(self):
        return sum([len(keys) for keys in self._keys_list])
...
@register_task("unimol_mixed_continual")
class UniMolMixedContinualTask(UnicoreTask):
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        raw_dataset = MergedLMDBDataset(split_path_list)
