...
class Oracle(ABC):
    ...
    that can interact with the pipeline
    
    This oracle is designed to work with molecules. It can be used to query the target value
    of a molecule, update the target value of a molecule, and update the annotations of a molecule.
    """
...
class BenchmarkOracle(Oracle):
    ...
    def query_target_value(self, data_manager: DataManager, idx: int) -> Any:
        ...
        """
        target_value = data_manager[idx]["target"][0]
        return target_value