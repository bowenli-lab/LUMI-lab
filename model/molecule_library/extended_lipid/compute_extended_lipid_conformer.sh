...
# we need 0-127, Kuan 0-63; 64-127
...
/h/pangkuan/miniconda3/envs/unimol/bin/python vector_rdkit_conformer_gen_customized_conformer.py --inpath ${input_file} --outpath ${output_file} --data_type "extended_lipid"