...
INPUT_DIR="/home/pangkuan/projects/def-bowenli/pangkuan/data/15m-lib/array-job-${failed_N}/partitioned_txt"
OUTPUT_DIR="/home/pangkuan/projects/def-bowenli/pangkuan/data/15m-lib/array-job-${failed_N}/lmdb"
