...
INPUT_DIR="/scratch/ssd004/datasets/cellxgene/3d_molecule_data/220k-lib/partitioned_csv"
OUTPUT_DIR="/scratch/ssd004/datasets/cellxgene/3d_molecule_data/220k-lib/lmdb"
