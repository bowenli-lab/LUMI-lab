...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # load cell plates
    cell_plate_1 = protocol.load_labware('biomartubottom_96_wellplate_200ul', location=cell_plate_1_location,
                                         label='Cell_Plate_1')
    cell_plate_2 = protocol.load_labware('biomartubottom_96_wellplate_200ul', location=cell_plate_2_location,
                                         label='Cell_Plate_2')
    cell_plate_3 = protocol.load_labware('biomartubottom_96_wellplate_200ul', location=cell_plate_3_location,
                                         label='Cell_Plate_3')
    cell_plate_4 = protocol.load_labware('biomartubottom_96_wellplate_200ul', location=cell_plate_4_location,
                                         label='Cell_Plate_4')
    cell_plate_5 = protocol.load_labware('biomartubottom_96_wellplate_200ul', location=cell_plate_5_location,
                                         label='Cell_Plate_5')
    cell_plate_6 = protocol.load_labware('biomartubottom_96_wellplate_200ul', location=cell_plate_6_location,
                                         label='Cell_Plate_6')
    cell_plate_7 = protocol.load_labware('biomartubottom_96_wellplate_200ul', location=cell_plate_7_location,
                                         label='Cell_Plate_7')
    cell_plate_8 = protocol.load_labware('biomartubottom_96_wellplate_200ul', location=cell_plate_8_location,
                                         label='Cell_Plate_8')
    cell_plate_9 = protocol.load_labware('biomartubottom_96_wellplate_200ul', location=cell_plate_9_location,
                                         label='Cell_Plate_9')
