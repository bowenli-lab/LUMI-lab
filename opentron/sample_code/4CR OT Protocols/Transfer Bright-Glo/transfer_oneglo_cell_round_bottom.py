...
# metadata
metadata = {
    'protocolName': "Transfer OneGlo - Round Bottom Plates",
    'author': 'Kevin <kevinchang.wang@mail.utoronto.ca>',
    'description': 'Opentrons liquid dispensing protocol to transfer OneGlo for round bottom plates following incubation',
    'apiLevel': '2.12'
}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # load pipette
    p300_multi = protocol.load_instrument('p300_multi_gen2', mount='right',
